...
public enum DocumentType {
    ...
    // C-CDA R2.0
    CCDA_R2_0_CCD_V2(is(R1), of("2.16.840.1.113883.10.20.22.1.2", "2014-06-09")),
    CCDA_R2_0_CARE_PLAN_V1(is(R1), of("2.16.840.1.113883.10.20.22.1.15", Optional.empty())),
    CCDA_R2_0_CONSULTATION_NOTE_V2(is(R1), of("2.16.840.1.113883.10.20.22.1.4", "2014-06-09")),
    CCDA_R2_0_DIAGNOSTIC_IMAGING_REPORT_V2(is(R1), of("2.16.840.1.113883.10.20.22.1.5", "2014-06-09")),
    CCDA_R2_0_DISCHARGE_SUMMARY_V2(is(R1), of("2.16.840.1.113883.10.20.22.1.8", "2014-06-09")),
    CCDA_R2_0_HISTORY_AND_PHYSICAL_V2(is(R1), of("2.16.840.1.113883.10.20.22.1.3", "2014-06-09")),
    CCDA_R2_0_OPERATIVE_NOTE_V2(is(R1), of("2.16.840.1.113883.10.20.22.1.7", "2014-06-09")),
    CCDA_R2_0_PROCEDURE_NOTE_V2(is(R1), of("2.16.840.1.113883.10.20.22.1.6", "2014-06-09")),
    CCDA_R2_0_PROGRESS_NOTE_V2(is(R1), of("2.16.840.1.113883.10.20.22.1.9", "2014-06-09")),
    CCDA_R2_0_REFERRAL_NOTE_V1(is(R1), of("2.16.840.1.113883.10.20.22.1.14", Optional.empty())),
    CCDA_R2_0_TRANSFER_SUMMARY_V1(is(R1), of("2.16.840.1.113883.10.20.22.1.13", Optional.empty())),
    CCDA_R2_0_UNSTRUCTURED_DOCUMENT_V2(is(R1), of("2.16.840.1.113883.10.20.22.1.10", "2014-06-09")),
    CCDA_R2_0_US_REALM_HEADER_FOR_PATIENT_GENERATED_DOCUMENT_V1(is(R1), of("2.16.840.1.113883.10.20.29.1", Optional.empty())),
