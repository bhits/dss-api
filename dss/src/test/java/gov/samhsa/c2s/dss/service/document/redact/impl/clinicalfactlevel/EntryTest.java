...
public class EntryTest {
    ...
    @Test
    public void testExecute() throws IOException, XPathExpressionException, SimpleMarshallerException {
        // Arrange
        ...
        assertEquals("entry", response.getRedactNodeList().get(0).getNodeName());
